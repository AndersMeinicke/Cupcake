...
class UserMapperTest
{
    ...
    private final static String PASSWORD = "anders";
    private final static String URL = "jdbc:mysql://localhost:3306/cupcake?serverTimezone=CET&allowPublicKeyRetrieval=true&useSSL=false";
